...
def square(freq, amplitude, duration):
	# TODO: Générer une onde carrée d'une fréquence et amplitude donnée.
	pass

def sawtooth(freq, amplitude, duration):
	# TODO: Générer une onde en dents de scie (sawtooth) à partir de l'amplitude et fréquence donnée.
	pass

def sine_with_overtones(root_freq, amplitude, overtones, duration):
	# TODO: Générer une onde sinusoïdale avec ses harmoniques. Le paramètre overtones est un dictionnaire où la clé est le multiple de la fondamentale et la valeur est l'amplitude relative de l'harmonique.
	pass

def normalize(samples, norm_target):
	# TODO: Normaliser un signal à l'amplitude donnée.
	pass
